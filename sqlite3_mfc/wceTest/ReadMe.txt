========================================================================
     Microsoft Foundation Class Library for Windows CE: wceTest
========================================================================


AppWizard has created this wceTest application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your wceTest application.
...
res\wceTest.ico
    ...
    icon is included by the main resource file wceTest.rc.
...
TestDlg.h, TestDlg.cpp - the dialog
    ...
    template is in wceTest.rc, which can be edited in Microsoft
	Developer Studio.
...
StdAfx.h, StdAfx.cpp
    ...
    named wceTest.pch and a precompiled types file named StdAfx.obj.
